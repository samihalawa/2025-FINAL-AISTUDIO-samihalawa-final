...
export const EVIDENCE_GAPS: EvidenceGap[] = [
  ...
  },
  {
    ...
    status: copy('111 valid media files and approximately 125.83 hours are verified at file level, with 271 notes/transcript/chat sidecars and 0 remaining timed-out media candidates. A full status TSV now covers all 111 rows; 12 Google sidecars, 7 local Valerio/Umbramed transcripts, 8 local Valerio/Umbramed chat sidecars and 4 root local chats have been read. Six local Valerio transcripts and one local Valerio chat are substantive; the other reviewed local Valerio sidecars stayed needs-review because they were repeated/no-substantive, sensitive, link-only, audio-check or logistics fragments. Full transcript/content review remains incomplete.', '111 archivos multimedia válidos y unas 125,83 horas están verificados a nivel de archivo, con 271 notas/transcripciones/chats auxiliares y 0 candidatos de media con timeout pendientes. Un TSV completo de estado cubre ya las 111 filas; se han leído 12 sidecars de Google, 7 transcripciones locales de Valerio/Umbramed, 8 chats locales de Valerio/Umbramed y 4 chats locales raíz. Seis transcripciones locales de Valerio y un chat local de Valerio son sustantivos; los demás sidecars locales revisados siguen pendientes porque eran repetitivos/sin contenido, sensibles, solo enlace, comprobación de audio o logística. La revisión completa de transcripciones/contenido sigue incompleta.'),
...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    currentState: copy('111 valid media files / approximately 125.83 hours are verified at file level; 271 sidecars are inventoried, 0 timed-out candidates remain, 12 Google sidecars plus 7 local Valerio/Umbramed transcripts plus 8 local Valerio/Umbramed chat sidecars plus 4 root local chats have been read and the full 111-row status TSV exists.', '111 archivos válidos / unas 125,83 horas están verificados a nivel de archivo; hay 271 sidecars inventariados, no quedan candidatos con timeout, se han leído 12 sidecars de Google más 7 transcripciones locales de Valerio/Umbramed más 8 chats locales de Valerio/Umbramed más 4 chats locales raíz y existe el TSV completo de estado de 111 filas.'),
    nextProofAction: copy('Review the 59 remaining needs-review rows with sidecar leads first; return to the 11 media-only-needs-transcript rows only when transcript extraction or manual review is needed for a public claim.', 'Revisar primero las 59 filas pendientes de revisión restantes con sidecars; volver a las 11 filas multimedia sin sidecar solo cuando haga falta extracción de transcripción o revisión manual para un claim público.'),
