...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: copy('Open-source agent that captures, annotates and reasons over live interfaces for visual debugging, published as visual-ui-debug-agent-mcp with 80+ GitHub stars, 7 forks and 900+ npm installs.', 'Agente abierto que captura, anota y razona sobre interfaces reales para depuración visual, publicado como visual-ui-debug-agent-mcp con más de 80 estrellas en GitHub, 7 forks y más de 900 instalaciones en npm.', 'Agent open source qui capture, annote et analyse des interfaces réelles pour le débogage visuel, publié sous le nom visual-ui-debug-agent-mcp avec plus de 80 étoiles GitHub, 7 forks et plus de 900 installations npm.', '用于可视化调试的开源智能体：捕获、标注并分析真实界面。以 visual-ui-debug-agent-mcp 发布，获得 80+ 个 GitHub star、7 次 fork 及 900+ 次 npm 安装。'),
...
export const PORTFOLIO_STORIES: PortfolioStory[] = [
  ...
  },
  {
    ...
    description: copy('Open-source tools that give coding agents better visibility into interfaces, context and operating state — VUDA carries 80+ GitHub stars and 900+ npm installs, and the email-smtp-imap-mcp server has passed 1,700+ npm installs.', 'Herramientas open source para que los agentes de programación entiendan mejor interfaces, contexto y estado operativo: VUDA acumula más de 80 estrellas en GitHub y más de 900 instalaciones en npm, y el servidor email-smtp-imap-mcp supera las 1.700 instalaciones en npm.', 'Outils open source qui donnent aux agents de code une meilleure visibilité sur les interfaces, le contexte et l’état opérationnel : VUDA compte plus de 80 étoiles GitHub et plus de 900 installations npm, et le serveur email-smtp-imap-mcp dépasse 1 700 installations npm.', '让编码智能体更好理解界面、上下文与运行状态的开源工具：VUDA 拥有 80+ 个 GitHub star 与 900+ 次 npm 安装，email-smtp-imap-mcp 服务器的 npm 安装量已超过 1,700 次。'),
