...
export const PORTFOLIO_INVENTORY: InventoryItem[] = [
  ...
  inventoryItem(51, 'timeline-umbramed', 'Umbramed / Valerio', '2025–2026', '2025 Q4', 'clients', 'verified', 'Clinical-study tooling, OPE exam-data ingestion, web/PWA recovery and installability advice, Diraya automation investigation, PWABuilder and Google Play Console packaging prep, Stripe/payment prep, arrhythmia-simulator review, retinography ML ideation and funding-application prep with Sami as technical lead.', 'Herramientas clínicas, ingesta de exámenes OPE, asesoría de recuperación e instalabilidad web/PWA, investigación de automatización Diraya, preparación de packaging con PWABuilder y Google Play Console, preparación Stripe/pagos, revisión de simulador de arritmias, ideación ML con retinografías y preparación de financiación con Sami como responsable técnico.', 'Site, repository, design records, €6,700 labelled cashflow and sampled Meet sidecars; applications are not awards, app-store/payment prep is not submission or completion.', 'Sitio, repositorio, documentación, €6.700 etiquetados y sidecars Meet muestreados; solicitudes no son premios, y preparación app-store/pagos no es envío ni finalización.', 'https://umbramed.es', '/portfolio/umbramed-home.png'),
...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    currentState: copy('111 valid media files / approximately 125.83 hours are verified at file level; 271 sidecars are inventoried, 0 timed-out candidates remain, 23 Google sidecars plus 7 local Valerio/Umbramed transcripts plus 8 local Valerio/Umbramed chat sidecars plus 4 root local chats have been read and the full 111-row status TSV exists.', '111 archivos válidos / unas 125,83 horas están verificados a nivel de archivo; hay 271 sidecars inventariados, no quedan candidatos con timeout, se han leído 23 sidecars de Google más 7 transcripciones locales de Valerio/Umbramed más 8 chats locales de Valerio/Umbramed más 4 chats locales raíz y existe el TSV completo de estado de 111 filas.'),
    nextProofAction: copy('Review the 50 remaining needs-review rows with sidecar leads first; return to the 11 media-only-needs-transcript rows only when transcript extraction or manual review is needed for a public claim.', 'Revisar primero las 50 filas pendientes de revisión restantes con sidecars; volver a las 11 filas multimedia sin sidecar solo cuando haga falta extracción de transcripción o revisión manual para un claim público.'),
