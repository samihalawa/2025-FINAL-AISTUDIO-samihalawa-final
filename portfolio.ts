...
import { INCLUDES_TRANSLATIONS, INVENTORY_FR, INVENTORY_ZH, STORY_FR, STORY_ZH } from './i18n/portfolioTranslations';
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    description: copy('Mandarin-first marketplace and local-life platform for Spain, live in production on web, iOS and Android.', 'Marketplace y plataforma de vida local para la comunidad china en España, en producción en web, iOS y Android.', 'Marketplace et plateforme locale pour la communauté chinoise en Espagne, en production sur web, iOS et Android.', '面向西班牙华人社区的中文市场与本地生活平台，已在 Web、iOS 与 Android 三端正式上线。'),
  ...
  },
  {
    ...
    description: copy('Pricing-intelligence and decision-reporting workflow combining marketplace data, product matching and inventory or ERP inputs, covering pricing intelligence and ERP integration.', 'Inteligencia de precios e informes de decisión con datos de marketplaces, matching e inventario o ERP, que cubre inteligencia de precios e integración ERP.', 'Flux d’intelligence tarifaire et de rapports de décision combinant données marketplace, appariement produit et entrées stock ou ERP, couvrant l’intelligence tarifaire et l’intégration ERP.', '结合市场数据、商品匹配与库存或 ERP 输入的定价情报与决策报告流程，涵盖定价情报与 ERP 集成。'),
  ...
  },
  {
    ...
    description: copy('Open-source agent that captures, annotates and reasons over live interfaces for visual debugging, published as visual-ui-debug-agent-mcp with 80+ GitHub stars, 7 forks and 900+ npm downloads.', 'Agente abierto que captura, anota y razona sobre interfaces reales para depuración visual, publicado como visual-ui-debug-agent-mcp con más de 80 estrellas en GitHub, 7 forks y más de 900 descargas en npm.', 'Agent open source qui capture, annote et analyse des interfaces réelles pour le débogage visuel, publié sous le nom visual-ui-debug-agent-mcp avec plus de 80 étoiles GitHub, 7 forks et plus de 900 téléchargements npm.', '用于可视化调试的开源智能体：捕获、标注并分析真实界面。以 visual-ui-debug-agent-mcp 发布，获得 80+ 个 GitHub star、7 次 fork 及 900+ 次 npm 下载。'),
  ...
  },
  {
    ...
    description: copy('Email transport and mailbox integration for agentic workflows, published as email-smtp-imap-mcp with 1,700+ npm downloads.', 'Transporte de email e integración de buzones para flujos agénticos, publicado como email-smtp-imap-mcp con más de 1.700 descargas en npm.', 'Transport email et intégration de boîtes aux lettres pour flux agentiques, publié sous le nom email-smtp-imap-mcp avec plus de 1 700 téléchargements npm.', '面向智能体工作流的邮件传输与邮箱集成，以 email-smtp-imap-mcp 发布，npm 下载量超过 1,700 次。'),
  ...
  },
  {
    ...
    description: copy('AI-assisted medical learning and multimodal-workflow product experimentation, grown out of the same clinical collaboration that produced APOLO on Hugging Face.', 'Aprendizaje médico y experimentación de flujos multimodales asistidos por IA, surgidos de la misma colaboración clínica que produjo APOLO en Hugging Face.', 'Apprentissage médical assisté par IA et expérimentation de flux multimodaux, issus de la même collaboration clinique ayant produit APOLO sur Hugging Face.', 'AI 辅助医学学习与多模态工作流产品实验，源自同一项临床合作——该合作在 Hugging Face 上产出了 APOLO。'),
...
export const PORTFOLIO_STORIES: PortfolioStory[] = [
  {
    id: 'oulang', name: 'OULANG (欧浪AI)', period: 'Build 2024–Jun 2026 · live product', category: 'platforms', featured: true,
    description: copy('A Mandarin-first marketplace and local-life product built for the Chinese community in Spain, live on web, iOS and Android.', 'Marketplace y producto de vida local en mandarín para la comunidad china en España, en producción en web, iOS y Android.', 'Marketplace et produit de vie locale en mandarin pour la communauté chinoise en Espagne, en production sur web, iOS et Android.', '面向西班牙华人社区的中文市场与本地生活产品，已在 Web、iOS 与 Android 上线。'),
  ...
  },
  {
    ...
    description: copy('A reviewable pricing and sourcing workflow for a refurbished-device operation, covering pricing intelligence and ERP integration.', 'Flujo revisable de pricing y sourcing para una operación de dispositivos reacondicionados, que cubre inteligencia de precios e integración ERP.', 'Flux de tarification et de sourcing vérifiable pour une activité d’appareils reconditionnés, couvrant l’intelligence tarifaire et l’intégration ERP.', '面向翻新设备业务的可审阅定价与采购流程，涵盖定价情报与 ERP 集成。'),
  ...
  },
  {
    ...
    description: copy('An agentic operating system for account research, enrichment, CRM work and multi-channel follow-up. A public LinkedIn recommendation cites 200+ qualified contacts in two weeks and a 30% lift in sales conversion.', 'Sistema operativo agéntico para investigación de cuentas, enriquecimiento, CRM y seguimiento multicanal. Una recomendación pública en LinkedIn cita más de 200 contactos cualificados en dos semanas y un aumento del 30% en la conversión de ventas.', 'Système d’exploitation agentique pour la recherche de comptes, l’enrichissement, le CRM et le suivi multicanal. Une recommandation publique LinkedIn cite plus de 200 contacts qualifiés en deux semaines et une hausse de 30 % de la conversion commerciale.', '面向客户调研、数据增强、CRM 与多渠道跟进的智能体操作系统。LinkedIn 公开推荐信提到两周内获得 200 多个合格联系人，销售转化率提升 30%。'),
  ...
  },
  {
    ...
    description: copy('Open-source tools that give coding agents better visibility into interfaces, context and operating state — VUDA carries 80+ GitHub stars and 900+ npm downloads, and the email-smtp-imap-mcp server has passed 1,700+ npm downloads.', 'Herramientas open source para que los agentes de programación entiendan mejor interfaces, contexto y estado operativo: VUDA acumula más de 80 estrellas en GitHub y más de 900 descargas en npm, y el servidor email-smtp-imap-mcp supera las 1.700 descargas en npm.', 'Outils open source qui donnent aux agents de code une meilleure visibilité sur les interfaces, le contexte et l’état opérationnel : VUDA compte plus de 80 étoiles GitHub et plus de 900 téléchargements npm, et le serveur email-smtp-imap-mcp dépasse 1 700 téléchargements npm.', '让编码智能体更好理解界面、上下文与运行状态的开源工具：VUDA 拥有 80+ 个 GitHub star 与 900+ 次 npm 下载，email-smtp-imap-mcp 服务器的 npm 下载量已超过 1,700 次。'),
