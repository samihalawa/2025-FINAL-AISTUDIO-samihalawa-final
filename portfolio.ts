...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    nextProofAction: copy('Review the 11 needs-transcript rows, then the 78 needs-review rows, filling project, participant, transcript status and public-safe claim only after sidecar read-back.', 'Revisar las 11 filas pendientes de transcripción y luego las 78 pendientes de revisión, completando proyecto, participantes, estado de transcripción y claim público solo tras leer el sidecar.'),
