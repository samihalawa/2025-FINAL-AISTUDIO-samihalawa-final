...
export const PORTFOLIO_INVENTORY: InventoryItem[] = [
  ...
  inventoryItem(87, 'timeline-career-rebuild', 'Career evidence rebuild', 'Jul 2026', '2026 Q3', 'infrastructure', 'verified', 'Cross-source reconciliation of repositories, clients, products, writing, recordings and live surfaces.', 'Conciliación de repositorios, clientes, productos, escritura, grabaciones y sitios.', '87 classified entries, 249 public originals, 749 local Git roots and explicit known gaps.', '87 entradas, 249 originales públicos, 749 raíces Git y lagunas explícitas.'),
];
...
export const LINKEDIN_MEDIA_ASSETS: LinkedInMediaAsset[] = [
  ...
  },
  {
    ...
    proof: copy('111 valid Meet Recording media files and approximately 125.83 hours are inventoried. A full 111-row status index now exists: 49 indexed, 38 needs-review, 13 private-skip and 11 media-only-needs-transcript. The current sidecar pass includes 32 Google Docs (Chinese lessons, five root-folder Chinese/admissions-prep lessons, one low-content technical setup fragment, three IWAKY/AutoPricing docs including a substantive 4 Jun 2026 demo packet, 9 Valerio/Umbramed sidecars (6 substantive, 3 low-content companion fragments), recipe intelligence and Tekçe/OULANG-AutoClient), seven local Valerio/Umbramed transcripts read (six substantive, covering 13 media rows), eight local Valerio/Umbramed chat sidecars read (one substantive), and four root local chat sidecars. The new AutoPricing packet proves demo-level evidence for dynamic ecommerce/tasación, mini-ERP stock and pricing, market scraping, Wallapop acquisition/contact automation and WhatsApp quote extraction; it does not prove acceptance, final payment, real sent-message delivery, production outcome or current live metrics.', '111 archivos multimedia válidos de Meet Recordings y aproximadamente 125,83 horas están inventariados. Ya existe un índice de estado completo de 111 filas: 49 indexadas, 38 pendientes de revisión, 13 privadas/no publicables sin redacción y 11 multimedia sin sidecar y pendientes de transcripción. El pase actual de sidecars incluye 32 Google Docs (clases de chino, cinco clases/admisiones de chino en carpeta raíz, un fragmento técnico de conexión de bajo contenido, tres documentos IWAKY/AutoPricing incluyendo un paquete demo sustantivo del 4 jun 2026, 9 sidecars Valerio/Umbramed (6 sustantivos, 3 fragmentos complementarios de bajo contenido), inteligencia de recetas y Tekçe/OULANG-AutoClient), siete transcripciones locales de Valerio/Umbramed leídas (seis sustantivas, cubriendo 13 filas multimedia), ocho chats locales de Valerio/Umbramed leídos (uno sustantivo) y cuatro chats locales raíz. El nuevo paquete AutoPricing prueba evidencia de demo para ecommerce/tasación dinámica, mini-ERP de stock y precios, scraping de mercado, automatización de captación/contacto en Wallapop y extracción de presupuestos de WhatsApp; no prueba aceptación, pago final, envío real de mensajes, resultado en producción ni métricas live actuales.'),
  },
  {
    id: 'linkedin-post20',
    post: 'Post 20',
...
export const EVIDENCE_GAPS: EvidenceGap[] = [
  ...
  },
  {
    ...
    status: copy('111 valid media files and approximately 125.83 hours are verified at file level, with 271 notes/transcript/chat sidecars and 0 remaining timed-out media candidates. A full status TSV now covers all 111 rows; 32 Google sidecars, 7 local Valerio/Umbramed transcripts, 8 local Valerio/Umbramed chat sidecars and 4 root local chats have been read. Substantive reads now include Chinese lessons/admissions prep, five root-folder Chinese/admissions-prep lessons, one low-content technical setup fragment, three IWAKY/AutoPricing docs including a 4 Jun 2026 demo packet, 9 Valerio/Umbramed sidecars (6 substantive, 3 low-content companion fragments), recipe intelligence and Tekçe/OULANG-AutoClient; reviewed non-promotions stayed bounded as repeated/no-substantive, sensitive, link-only, audio-check, logistics or low-content fragments. Full transcript/content review remains incomplete, with 38 needs-review rows still open.', '111 archivos multimedia válidos y unas 125,83 horas están verificados a nivel de archivo, con 271 notas/transcripciones/chats auxiliares y 0 candidatos de media con timeout pendientes. Un TSV completo de estado cubre ya las 111 filas; se han leído 32 sidecars de Google, 7 transcripciones locales de Valerio/Umbramed, 8 chats locales de Valerio/Umbramed y 4 chats locales raíz. Las lecturas sustantivas incluyen clases/admisiones de chino, cinco clases/admisiones de chino en carpeta raíz, un fragmento técnico de conexión de bajo contenido, tres documentos IWAKY/AutoPricing incluyendo un paquete demo del 4 jun 2026, 9 sidecars Valerio/Umbramed (6 sustantivos, 3 fragmentos complementarios de bajo contenido), inteligencia de recetas y Tekçe/OULANG-AutoClient; los no-promovidos quedan acotados como repetitivos/sin contenido, sensibles, solo enlace, comprobación de audio, logística o bajo contenido. La revisión completa de transcripciones/contenido sigue incompleta, con 38 filas needs-review abiertas.'),
...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    currentState: copy('111 valid media files / approximately 125.83 hours are verified at file level; 271 sidecars are inventoried, 0 timed-out candidates remain, 32 Google sidecars plus 7 local Valerio/Umbramed transcripts plus 8 local Valerio/Umbramed chat sidecars plus 4 root local chats have been read and the full 111-row status TSV exists.', '111 archivos válidos / unas 125,83 horas están verificados a nivel de archivo; hay 271 sidecars inventariados, no quedan candidatos con timeout, se han leído 32 sidecars de Google más 7 transcripciones locales de Valerio/Umbramed más 8 chats locales de Valerio/Umbramed más 4 chats locales raíz y existe el TSV completo de estado de 111 filas.'),
    nextProofAction: copy('Review the 38 remaining needs-review rows with sidecar leads first; return to the 11 media-only-needs-transcript rows only when transcript extraction or manual review is needed for a public claim.', 'Revisar primero las 38 filas pendientes de revisión restantes con sidecars; volver a las 11 filas multimedia sin sidecar solo cuando haga falta extracción de transcripción o revisión manual para un claim público.'),
  ...
  },
  {
    ...
    currentState: copy('Targeted searches recovered the main 87-entry chronology; exhaustive page/message-level reconciliation is still open.', 'Las búsquedas dirigidas recuperaron la cronología principal de 87 entradas; la conciliación exhaustiva por página/mensaje sigue abierta.'),
