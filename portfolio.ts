...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: copy('Ionic/Capacitor clinical-study tooling, exam-data ingestion, PWA/web recovery and installability, Diraya automation investigation, PWABuilder and Google Play Console packaging prep, Stripe/payment prep, arrhythmia-simulator review, retinography ML ideation and funding-application prep with Sami as technical lead and Dr. Valerio Trigos as clinical lead.', 'Herramientas clínicas y de estudio en Ionic/Capacitor, ingesta de exámenes, recuperación e instalabilidad web/PWA, investigación de automatización Diraya, preparación de packaging con PWABuilder y Google Play Console, preparación Stripe/pagos, revisión de simulador de arritmias, ideación ML con retinografías y preparación de financiación con Sami como responsable técnico y el Dr. Valerio Trigos como responsable clínico.'),
...
export const PORTFOLIO_INVENTORY: InventoryItem[] = [
  ...
  inventoryItem(51, 'timeline-umbramed', 'Umbramed / Valerio', '2025–2026', '2025 Q4', 'clients', 'verified', 'Clinical-study tooling, OPE exam-data ingestion, web/PWA recovery and installability advice, Diraya automation investigation, PWABuilder and Google Play Console packaging prep, Stripe/payment prep, arrhythmia-simulator review, retinography ML ideation, promotional audio/teleprompter workflow, logo/icon optimization, final Umbramez redesign and Autonomous Clone prompt delivery with Sami as technical lead.', 'Herramientas clínicas, ingesta de exámenes OPE, asesoría de recuperación e instalabilidad web/PWA, investigación de automatización Diraya, preparación de packaging con PWABuilder y Google Play Console, preparación Stripe/pagos, revisión de simulador de arritmias, ideación ML con retinografías, flujo de audio/teleprompter promocional, optimización de logo/icono, rediseño final Umbramez y entrega del prompt Autonomous Clone con Sami como responsable técnico.', 'Site, repository, design records, €6,700 labelled cashflow and sampled Meet sidecars; applications are not awards, app-store/payment prep is not submission or completion, and prompt delivery is not a clone-product launch.', 'Sitio, repositorio, documentación, €6.700 etiquetados y sidecars Meet muestreados; solicitudes no son premios, la preparación app-store/pagos no es envío ni finalización y la entrega de prompts no es lanzamiento de un producto clonado.', 'https://umbramed.es', '/portfolio/umbramed-home.png'),
  ...
  inventoryItem(59, 'timeline-umbramed-continuation', 'Umbramed continuation', '2026', '2026 Q1', 'clients', 'verified', 'Continued technical, site, exam-ingestion, PWA recovery/installability, Diraya automation investigation, app-store/payment prep, promotional-audio/script workflow, logo/icon optimization and application work.', 'Continuación del trabajo técnico, del sitio, de ingesta de exámenes, recuperación/instalabilidad PWA, investigación de automatización Diraya, preparación app-store/pagos, flujo de audio/guion promocional, optimización de logo/icono y solicitudes.', '2026 repository, site and Feb 2026 Meet sidecars; applications remain applications and recovery/app-store/payment prep is not acceptance, submission or completion.', 'Repositorio, sitio y sidecars Meet de feb 2026; las solicitudes siguen siendo solicitudes y la recuperación/preparación app-store/pagos no es aceptación, envío ni finalización.', 'https://github.com/samihalawa/umbramed-eic-2026'),
...
export const LINKEDIN_MEDIA_ASSETS: LinkedInMediaAsset[] = [
  ...
  },
  {
    ...
    proof: copy('111 valid Meet Recording media files and approximately 125.83 hours are inventoried. A full 111-row status index now exists: 39 indexed, 48 needs-review, 13 private-skip and 11 media-only-needs-transcript. The current sidecar pass includes 24 Google Docs (Chinese lessons, four root-folder Chinese lessons, IWAKY, five Valerio/Umbramed sidecars, recipe intelligence and Tekçe/OULANG-AutoClient), seven local Valerio/Umbramed transcripts read (six substantive, covering 13 media rows), eight local Valerio/Umbramed chat sidecars read (one substantive), and four root local chat sidecars.', '111 archivos multimedia válidos de Meet Recordings y aproximadamente 125,83 horas están inventariados. Ya existe un índice de estado completo de 111 filas: 39 indexadas, 48 pendientes de revisión, 13 privadas/no publicables sin redacción y 11 multimedia sin sidecar y pendientes de transcripción. El pase actual de sidecars incluye 24 Google Docs (clases de chino, cuatro clases de chino en carpeta raíz, IWAKY, cinco sidecars Valerio/Umbramed, inteligencia de recetas y Tekçe/OULANG-AutoClient), siete transcripciones locales de Valerio/Umbramed leídas (seis sustantivas, cubriendo 13 filas multimedia), ocho chats locales de Valerio/Umbramed leídos (uno sustantivo) y cuatro chats locales raíz.'),
  },
  {
    id: 'linkedin-post20',
    post: 'Post 20',
...
export const EVIDENCE_GAPS: EvidenceGap[] = [
  ...
  },
  {
    ...
    status: copy('111 valid media files and approximately 125.83 hours are verified at file level, with 271 notes/transcript/chat sidecars and 0 remaining timed-out media candidates. A full status TSV now covers all 111 rows; 24 Google sidecars, 7 local Valerio/Umbramed transcripts, 8 local Valerio/Umbramed chat sidecars and 4 root local chats have been read. Substantive reads now include Chinese lessons, four root-folder Chinese lessons, IWAKY, five Valerio/Umbramed sidecars, recipe intelligence and Tekçe/OULANG-AutoClient; reviewed non-promotions stayed bounded as repeated/no-substantive, sensitive, link-only, audio-check, logistics or low-content fragments. Full transcript/content review remains incomplete.', '111 archivos multimedia válidos y unas 125,83 horas están verificados a nivel de archivo, con 271 notas/transcripciones/chats auxiliares y 0 candidatos de media con timeout pendientes. Un TSV completo de estado cubre ya las 111 filas; se han leído 24 sidecars de Google, 7 transcripciones locales de Valerio/Umbramed, 8 chats locales de Valerio/Umbramed y 4 chats locales raíz. Las lecturas sustantivas incluyen clases de chino, cuatro clases de chino en carpeta raíz, IWAKY, cinco sidecars Valerio/Umbramed, inteligencia de recetas y Tekçe/OULANG-AutoClient; los no-promovidos quedan acotados como repetitivos/sin contenido, sensibles, solo enlace, comprobación de audio, logística o bajo contenido. La revisión completa de transcripciones/contenido sigue incompleta.'),
...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    currentState: copy('111 valid media files / approximately 125.83 hours are verified at file level; 271 sidecars are inventoried, 0 timed-out candidates remain, 24 Google sidecars plus 7 local Valerio/Umbramed transcripts plus 8 local Valerio/Umbramed chat sidecars plus 4 root local chats have been read and the full 111-row status TSV exists.', '111 archivos válidos / unas 125,83 horas están verificados a nivel de archivo; hay 271 sidecars inventariados, no quedan candidatos con timeout, se han leído 24 sidecars de Google más 7 transcripciones locales de Valerio/Umbramed más 8 chats locales de Valerio/Umbramed más 4 chats locales raíz y existe el TSV completo de estado de 111 filas.'),
    nextProofAction: copy('Review the 48 remaining needs-review rows with sidecar leads first; return to the 11 media-only-needs-transcript rows only when transcript extraction or manual review is needed for a public claim.', 'Revisar primero las 48 filas pendientes de revisión restantes con sidecars; volver a las 11 filas multimedia sin sidecar solo cuando haga falta extracción de transcripción o revisión manual para un claim público.'),
