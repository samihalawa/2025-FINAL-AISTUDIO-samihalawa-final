...
export const PORTFOLIO_INVENTORY: InventoryItem[] = [
  ...
  inventoryItem(51, 'timeline-umbramed', 'Umbramed / Valerio', '2025–2026', '2025 Q4', 'clients', 'verified', 'Clinical-study tooling, OPE exam-data ingestion, Claude/Table connector exam-upload workflows, web/PWA recovery and installability advice, Diraya automation investigation, PWABuilder and Google Play Console packaging prep, Stripe connector/payment-integration prep, arrhythmia-simulator review, retinography ML ideation, promotional audio/teleprompter workflow, logo/icon optimization, final Umbramez redesign and Autonomous Clone prompt delivery with Sami as technical lead.', 'Herramientas clínicas, ingesta de exámenes OPE, flujos de subida de exámenes con conectores Claude/Table, asesoría de recuperación e instalabilidad web/PWA, investigación de automatización Diraya, preparación de packaging con PWABuilder y Google Play Console, preparación de conectores Stripe/pagos, revisión de simulador de arritmias, ideación ML con retinografías, flujo de audio/teleprompter promocional, optimización de logo/icono, rediseño final Umbramez y entrega del prompt Autonomous Clone con Sami como responsable técnico.', 'Site, repository, design records, €6,700 labelled cashflow and sampled Meet sidecars; applications are not awards, app-store/payment prep is not submission or completion, connector/payment prep is not completed payment integration, and prompt delivery is not a clone-product launch.', 'Sitio, repositorio, documentación, €6.700 etiquetados y sidecars Meet muestreados; solicitudes no son premios, la preparación app-store/pagos no es envío ni finalización, la preparación de conectores/pagos no es integración de pagos completada y la entrega de prompts no es lanzamiento de un producto clonado.', 'https://umbramed.es', '/portfolio/umbramed-home.png'),
  ...
  inventoryItem(59, 'timeline-umbramed-continuation', 'Umbramed continuation', '2026', '2026 Q1', 'clients', 'verified', 'Continued technical, site, exam-ingestion, Claude/Table connector workflow support, PWA recovery/installability, Diraya automation investigation, app-store/payment prep, Stripe connector/payment-integration preparation, promotional-audio/script workflow, logo/icon optimization and application work.', 'Continuación del trabajo técnico, del sitio, de ingesta de exámenes, soporte de flujos con conectores Claude/Table, recuperación/instalabilidad PWA, investigación de automatización Diraya, preparación app-store/pagos, preparación de conectores Stripe/pagos, flujo de audio/guion promocional, optimización de logo/icono y solicitudes.', '2026 repository, site and Feb 2026 Meet sidecars; applications remain applications and recovery/app-store/payment/connector prep is not acceptance, submission, completion or revenue.', 'Repositorio, sitio y sidecars Meet de feb 2026; las solicitudes siguen siendo solicitudes y la recuperación/preparación app-store/pagos/conectores no es aceptación, envío, finalización ni ingresos.', 'https://github.com/samihalawa/umbramed-eic-2026'),
  ...
  inventoryItem(80, 'timeline-recipes', 'Recipe intelligence with José Olivares', 'Jul 2026', '2026 Q3', 'research', 'verified', 'Scan chef notes/photos, extract structured recipes, research video/web sources, preserve technique, publish multilingual views and generate recipe media.', 'Escanear notas/fotos de chef, extraer recetas estructuradas, investigar web/vídeo, preservar técnica, publicar vistas multilingües y generar medios.', '8 Jul Meet transcript sidecar verified; no finished product, signed contract, payment, traffic or revenue claim.', 'Sidecar/transcripción del 8 jul verificado; sin producto terminado, contrato firmado, pago, tráfico ni ingresos.'),
  inventoryItem(81, 'timeline-tekce-oulang-autoclient', 'Tekçe / OULANG-AutoClient lead-generation discussion', 'Jul 2026', '2026 Q3', 'clients', 'verified', 'Property lead-generation partnership/demo discussion around qualified Chinese buyers, CRM-auditable lead handling and personalised AI outreach.', 'Discusión comercial/demo de generación de leads inmobiliarios con compradores chinos cualificados, gestión auditable en CRM y outreach personalizado con IA.', '15 Jul Meet English sidecar verified; proposal/demo only, with no signed partnership, payment, revenue, delivered campaign, conversion or partner acceptance claim.', 'Sidecar inglés de Meet del 15 jul verificado; solo propuesta/demo, sin partnership firmado, pago, ingresos, campaña entregada, conversión ni aceptación.'),
  ...
  inventoryItem(83, 'timeline-ea-housing', 'EA Housing / Radio Inter proposals', 'Jul 2026', '2026 Q3', 'clients', 'verified', 'Modular proposal package for separate companies and a group option.', 'Paquete modular para empresas separadas y opción de grupo.', 'Current proposal repository; no signed contract, payment or delivery.', 'Repositorio actual; sin contrato firmado, pago ni entrega.'),
  ...
  inventoryItem(87, 'timeline-eva-training-scope', 'EVA AI/admin automation training scoping', 'Nov 2025', '2025 Q4', 'education', 'verified', 'AI/admin automation training consultation around Copilot, prompting, browser-click automation, local file/accounting organization, Microsoft To Do, a 20–30 hour class proposal and FUNDAE/subsidy logistics.', 'Consultoría de formación en IA/automatización administrativa sobre Copilot, prompting, automatización de clics en navegador, organización local de archivos/contabilidad, Microsoft To Do, propuesta de 20–30 horas y logística FUNDAE/subvención.', '11 Nov 2025 Google Meet sidecar verified; training scope/proposal evidence only, with no signed contract, payment, delivery, adoption or learner-outcome claim.', 'Sidecar Google Meet del 11 nov 2025 verificado; solo evidencia de alcance/propuesta, sin contrato firmado, pago, impartición, adopción ni resultado de alumnos.'),
  inventoryItem(88, 'timeline-mike-lepcsik-automation', 'Mike Lepcsik lead-generation automation consulting', 'Nov 2025', '2025 Q4', 'clients', 'verified', 'Lead-generation and business-automation consulting around N8N, Close CRM, Lead Feeder credentials/API issues, Google Maps/Search enrichment, MCP/agent architecture and AutoClient-style lead enrichment.', 'Consultoría de generación de leads y automatización empresarial con N8N, Close CRM, problemas de credenciales/API de Lead Feeder, enriquecimiento Google Maps/Search, arquitectura MCP/agentes y enriquecimiento tipo AutoClient.', '12 Nov 2025 Google Meet sidecar verified; consulting/proposal evidence only, with no delivered client software, signed contract, paid engagement, production integration or sales-outcome claim.', 'Sidecar Google Meet del 12 nov 2025 verificado; solo evidencia de consultoría/propuesta, sin software entregado, contrato firmado, encargo pagado, integración en producción ni resultado comercial.'),
  inventoryItem(89, 'timeline-solmade-fashion-ai', 'SOLMADE fashion AI/marketing proposal discovery', 'Jan 2026', '2026 Q1', 'clients', 'verified', 'Fashion AI and marketing discovery around AI-driven branding, website/app rebuild, SEO/blog automation, AI product/model imagery, social content generation, ads, mockups/tech packs and generated product videos/images.', 'Discovery de IA y marketing para moda sobre branding con IA, reconstrucción web/app, automatización SEO/blog, imágenes de producto/modelo generadas, contenido social, anuncios, mockups/tech packs y vídeos/imágenes de producto generados.', '9 Jan 2026 Google Meet sidecars verified; proposal/discovery evidence only, with no signed contract, delivery, revenue, global expansion, app launch, ad outcome or client-acceptance claim.', 'Sidecars Google Meet del 9 ene 2026 verificados; solo evidencia de propuesta/discovery, sin contrato firmado, entrega, ingresos, expansión global, lanzamiento app, resultado publicitario ni aceptación de cliente.'),
...
export const LINKEDIN_MEDIA_ASSETS: LinkedInMediaAsset[] = [
  ...
  },
  {
    ...
    proof: copy('111 valid Meet Recording media files and approximately 125.83 hours are inventoried. All 111 rows have archive status=indexed; content review is now 54 indexed, 33 needs-review, 13 private-skip and 11 media-only-needs-transcript. The current sidecar pass includes 37 Google Docs: Chinese lessons/admissions-prep, IWAKY/AutoPricing, Valerio/Umbramed, recipe intelligence, Tekçe/OULANG-AutoClient, EVA AI/admin training scoping, Mike Lepcsik automation consulting and SOLMADE fashion AI/marketing proposal discovery. These additions prove bounded consulting/proposal/discovery records only; they do not prove contracts, payment, delivery, acceptance, production outcome or current live metrics.', '111 archivos multimedia válidos de Meet Recordings y aproximadamente 125,83 horas están inventariados. Las 111 filas tienen status de archivo=indexed; la revisión de contenido queda en 54 indexadas, 33 pendientes, 13 privadas/no publicables sin redacción y 11 media-only-needs-transcript. El pase actual incluye 37 Google Docs: clases/admisiones de chino, IWAKY/AutoPricing, Valerio/Umbramed, inteligencia de recetas, Tekçe/OULANG-AutoClient, formación IA/administración EVA, consultoría de automatización Mike Lepcsik y discovery de IA/marketing para moda SOLMADE. Estas adiciones prueban solo registros acotados de consultoría/propuesta/discovery; no prueban contratos, pago, entrega, aceptación, resultado en producción ni métricas live actuales.'),
  },
  {
    id: 'linkedin-post20',
    post: 'Post 20',
    ...
    proof: copy('Verified 8 Jul 2026 Meet sidecar for AI-driven recipe extraction/enrichment, chef/user views, multilingual publishing and generated recipe-video workflows. Not a shipped-product or revenue claim.', 'Sidecar de Meet del 8 jul 2026 verificado para extracción/enriquecimiento de recetas con IA, vistas chef/usuario, publicación multilingüe y vídeos generados. No es producto lanzado ni claim de ingresos.'),
  },
];
...
export const EVIDENCE_GAPS: EvidenceGap[] = [
  ...
  },
  {
    ...
    status: copy('111 valid media files and approximately 125.83 hours are verified at file level, with 271 notes/transcript/chat sidecars and 0 remaining timed-out media candidates. All 111 archive rows are indexed; content review is 54 indexed, 33 needs-review, 13 private-skip and 11 media-only-needs-transcript. Thirty-seven Google sidecars have now been read, alongside 7 local Valerio/Umbramed transcripts, 8 local Valerio/Umbramed chat sidecars and 4 root local chats. Substantive reads now include Chinese lessons/admissions prep, IWAKY/AutoPricing, Valerio/Umbramed, recipe intelligence, Tekçe/OULANG-AutoClient, EVA AI/admin training scoping, Mike Lepcsik automation consulting and SOLMADE fashion AI/marketing proposal discovery. Full transcript/content review remains incomplete, with 33 needs-review rows still open.', '111 archivos multimedia válidos y unas 125,83 horas están verificados a nivel de archivo, con 271 notas/transcripciones/chats auxiliares y 0 candidatos de media con timeout pendientes. Las 111 filas de archivo están indexadas; la revisión de contenido queda en 54 indexadas, 33 pendientes, 13 privadas/no publicables y 11 media-only-needs-transcript. Se han leído 37 sidecars de Google, además de 7 transcripciones locales de Valerio/Umbramed, 8 chats locales de Valerio/Umbramed y 4 chats locales raíz. Las lecturas sustantivas incluyen clases/admisiones de chino, IWAKY/AutoPricing, Valerio/Umbramed, inteligencia de recetas, Tekçe/OULANG-AutoClient, formación IA/administración EVA, consultoría de automatización Mike Lepcsik y discovery de IA/marketing para moda SOLMADE. La revisión completa de transcripciones/contenido sigue incompleta, con 33 filas needs-review abiertas.'),
    nextStep: copy('Continue exporting and reading Drive sidecars, then fill participant/content summaries only after transcript read-back and privacy review.', 'Seguir exportando y leyendo sidecars de Drive; después completar participantes y resúmenes de contenido solo tras leer transcripciones y revisar privacidad.'),
  },
  {
    ...
    status: copy('Coolify now has a dated 22-resource snapshot: 10 running:healthy, 11 running:unknown and 1 exited:unhealthy. Public OULANG store listings were verified for legacy com.oulang.classifieds; app-store metrics and current oulang.app console state still need authenticated read-back.', 'Coolify ya tiene una captura fechada de 22 recursos: 10 running:healthy, 11 running:unknown y 1 exited:unhealthy. Las tiendas públicas de OULANG se verificaron para la identidad heredada com.oulang.classifieds; métricas y estado de consola de oulang.app siguen pendientes.'),
    nextStep: copy('Continue with App Store Connect, Play Console, Cloudflare, Vercel, Netlify, Google Cloud, RevenueCat, PostHog, Stripe and DNS read-backs.', 'Continuar con lecturas de App Store Connect, Play Console, Cloudflare, Vercel, Netlify, Google Cloud, RevenueCat, PostHog, Stripe y DNS.'),
  },
  {
    id: 'client-outcomes',
...
export const PROGRESSION_PLAN_STEPS: ProgressionPlanStep[] = [
  {
    ...
    currentState: copy('111 valid media files / approximately 125.83 hours are verified at file level; 271 sidecars are inventoried, 0 timed-out candidates remain, 37 Google sidecars plus 7 local Valerio/Umbramed transcripts plus 8 local Valerio/Umbramed chat sidecars plus 4 root local chats have been read and the full 111-row TSV separates archive status from content-review status.', '111 archivos válidos / unas 125,83 horas están verificados a nivel de archivo; hay 271 sidecars inventariados, no quedan candidatos con timeout, se han leído 37 sidecars de Google más 7 transcripciones locales de Valerio/Umbramed más 8 chats locales de Valerio/Umbramed más 4 chats locales raíz y el TSV de 111 filas separa status de archivo y status de revisión de contenido.'),
    nextProofAction: copy('Review the 33 remaining needs-review rows with sidecar leads first; return to the 11 media-only-needs-transcript rows only when transcript extraction or manual review is needed for a public claim.', 'Revisar primero las 33 filas pendientes de revisión restantes con sidecars; volver a las 11 filas multimedia sin sidecar solo cuando haga falta extracción de transcripción o revisión manual para un claim público.'),
  ...
  },
  {
    ...
    currentState: copy('First provider pass is in: Coolify returned 22 app resources on 16 Jul 2026, and OULANG public App Store / Google Play pages returned 200 for legacy com.oulang.classifieds. That is not a 22-live-product claim and not a current oulang.app console verdict.', 'Primera pasada de proveedores: Coolify devolvió 22 recursos de app el 16 jul 2026 y las páginas públicas de App Store / Google Play de OULANG respondieron 200 para la identidad heredada com.oulang.classifieds. No significa 22 productos vivos ni veredicto actual de consola para oulang.app.'),
    nextProofAction: copy('Read App Store Connect, Play Console, Cloudflare, Vercel, Netlify, Google Cloud, RevenueCat, PostHog, Stripe and DNS directly before publishing metrics, review states or broader domain counts.', 'Leer App Store Connect, Play Console, Cloudflare, Vercel, Netlify, Google Cloud, RevenueCat, PostHog, Stripe y DNS antes de publicar métricas, estados de revisión o recuentos amplios de dominios.'),
  ...
  },
  {
    ...
    currentState: copy('Targeted searches recovered the main 90-entry chronology; exhaustive page/message-level reconciliation is still open.', 'Las búsquedas dirigidas recuperaron la cronología principal de 90 entradas; la conciliación exhaustiva por página/mensaje sigue abierta.'),
