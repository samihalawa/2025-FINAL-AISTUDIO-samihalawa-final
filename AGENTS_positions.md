...
- **Triggers / verification:** CV, resume, role family, application, visual, ATS or internal notes; verify every file URL/MIME and exact source hash, all twelve PDF pages, all 85 recruiter-facing projects, every current validated credential ID, ATS parsing and the rendered desktop/mobile route.
