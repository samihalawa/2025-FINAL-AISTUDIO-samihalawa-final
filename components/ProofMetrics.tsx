...
const content: Record<LanguageCode, { eyebrow: string; metrics: Metric[] }> = {
  en: {
    ...
    metrics: [
      ...
      { value: '2,500+', label: 'Open-source MCP tool downloads', detail: 'VUDA visual debugging agent (900+ npm downloads, 80+★) and email-smtp-imap-mcp (1,700+ npm downloads), as recorded on npm and GitHub in September 2026.', href: '/case-studies/vuda' },
  ...
  es: {
    ...
    metrics: [
      ...
      { value: '2.500+', label: 'Descargas de herramientas MCP open source', detail: 'Agente de depuración visual VUDA (900+ descargas npm, 80+★) y email-smtp-imap-mcp (1.700+ descargas npm), según npm y GitHub en septiembre de 2026.', href: '/case-studies/vuda' },
  ...
  fr: {
    ...
    metrics: [
      ...
      { value: '2 500+', label: 'Téléchargements d’outils MCP open source', detail: 'Agent de débogage visuel VUDA (900+ téléchargements npm, 80+★) et email-smtp-imap-mcp (1 700+ téléchargements npm), relevés sur npm et GitHub en septembre 2026.', href: '/case-studies/vuda' },
  ...
  zh: {
    ...
    metrics: [
      ...
      { value: '2,500+', label: '开源 MCP 工具下载量', detail: 'VUDA 视觉调试智能体（900+ npm 下载，80+★）与 email-smtp-imap-mcp（1,700+ npm 下载），数据取自 2026 年 9 月的 npm 与 GitHub。', href: '/case-studies/vuda' },
