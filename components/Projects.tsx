...
const headings: Record<LanguageCode, {
  ...
  en: {
    ...
    approachBody: 'Working directly with clients, engineers and operational stakeholders, so product decisions, technical architecture and the operating reality stay connected from the first decision to the live service.',
    approach: [
  ...
  es: {
    ...
    approachBody: 'Trabajo directamente con clientes, ingenieros y responsables de operaciones, para que las decisiones de producto, la arquitectura técnica y la realidad operativa sigan conectadas desde la primera decisión hasta el servicio en marcha.',
    approach: [
  ...
  fr: {
    ...
    approachBody: 'Je travaille directement avec les clients, les ingénieurs et les responsables opérationnels, afin que les décisions produit, l’architecture technique et la réalité d’exploitation restent reliées, de la première décision au service en production.',
    approach: [
  ...
  zh: {
    ...
    approachBody: '我直接与客户、工程师和运营相关方协作，让产品决策、技术架构与真实运营情况从第一项决策一直连接到上线服务。',
    approach: [
