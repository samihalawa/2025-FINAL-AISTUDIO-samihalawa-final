...
const headings: Record<LanguageCode, {
  ...
  en: {
    ...
    open: 'Open project',
    ctaEyebrow: 'Full-time opportunities',
    ctaTitle: 'Looking for senior AI engineering or technical leadership?',
    ctaBody: 'I am based in Madrid and available for full-time roles across Spain and Europe.',
    cta: 'Discuss a role',
  },
  es: {
    ...
    open: 'Abrir proyecto',
    ctaEyebrow: 'Oportunidades a jornada completa',
    ctaTitle: '¿Buscas ingeniería sénior de IA o liderazgo técnico?',
    ctaBody: 'Estoy en Madrid y disponible para puestos a jornada completa en España y Europa.',
    cta: 'Hablar de un rol',
  },
  fr: {
    ...
    ctaEyebrow: 'Postes à temps plein',
    ctaTitle: 'Vous recherchez un ingénieur IA senior ou un lead technique ?',
    ctaBody: 'Basé à Madrid, je suis disponible pour des postes à temps plein en Espagne et en Europe.',
    cta: 'Parler d’un rôle',
  },
  zh: {
    ...
    open: '打开项目',
    ctaEyebrow: '全职机会',
    ctaTitle: '正在寻找高级 AI 工程师或技术负责人？',
    ctaBody: '我常驻马德里，可在西班牙及欧洲担任全职职位。',
    cta: '沟通岗位',
  },
};
