...
const headings: Record<LanguageCode, {
  ...
  en: {
    ...
    ledgerTitle: '90 classified entries. Nothing silently dropped.',
  ...
  es: {
    ...
    ledgerTitle: '90 entradas clasificadas. Nada desaparece en silencio.',
  ...
  fr: {
    ...
    ledgerTitle: '90 entrées classées. Rien ne disparaît.',
  ...
  zh: {
    ...
    proof: '打开证据', boundary: '证据边界', ledgerEyebrow: '完整时间线', ledgerTitle: '90 条分类记录，没有静默遗漏。', ledgerBody: '搜索完整证据账本，或按工作类型和验证状态筛选。',
