...
const copy: Record<LanguageCode, { title: string; roles: { years: string; title: string; company: string; body: string }[] }> = {
  en: { title: 'Professional chronology', roles: [
    { years: 'Jul 2025–Jun 2026', title: 'Founding AI Engineer & Systems Architect', company: 'Agents AI Ltd', body: 'OULANG across web, iOS and Android; agentic and multi-agent systems with durable state, tool calling, structured outputs and human review; multilingual retrieval, FastAPI inference, model routing, evaluation and self-hosted ML infrastructure.' },
    { years: 'Mar 2024–Jul 2025', title: 'Founder & Agentic AI Systems Architect', company: 'AutoClient AI', body: 'Multilingual outbound voice and outreach agents with live CRM context; selected by Lanzadera in 2025.' },
  ...
  es: { title: 'Cronología profesional', roles: [
    { years: 'Jul 2025–Jun 2026', title: 'Ingeniero Fundador de IA y Arquitecto de Sistemas', company: 'Agents AI Ltd', body: 'OULANG en web, iOS y Android; sistemas agénticos y multiagente con estado, tool calling, salidas estructuradas y revisión humana; búsqueda multilingüe, inferencia FastAPI, enrutado de modelos, evaluación e infraestructura ML autogestionada.' },
    { years: 'Mar 2024–Jul 2025', title: 'Fundador y Arquitecto de Sistemas de IA Agéntica', company: 'AutoClient AI', body: 'Agentes multilingües de voz y outreach con contexto CRM en vivo; seleccionado por Lanzadera en 2025.' },
