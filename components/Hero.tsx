...
const content: Record<LanguageCode, {
  ...
  en: {
    ...
    now: 'Working model', building: ['Architecture, backend and deployment owned by one person', 'Human review designed into consequential external actions', 'Cost and observability designed in from day one']
  },
  es: {
    ...
    now: 'Forma de trabajar', building: ['Arquitectura, backend y despliegue en manos de una sola persona', 'Revisión humana integrada en las acciones externas con consecuencias', 'Coste y observabilidad diseñados desde el primer día']
  },
  fr: {
    ...
    now: 'Façon de travailler', building: ['Architecture, backend et déploiement pris en charge par une seule personne', 'Revue humaine intégrée aux actions externes à conséquences', 'Coût et observabilité conçus dès le premier jour']
  },
  zh: {
    eyebrow: '马德里 · 欧洲 · 远程',
    name: 'Sami Halawa —',
    ...
    now: '工作方式', building: ['架构、后端与部署由一人完整负责', '对有实际影响的外部动作内置人工审核', '成本与可观测性从第一天起就纳入设计']
  }
};
