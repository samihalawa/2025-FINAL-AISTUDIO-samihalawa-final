            ...
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center">
                        <Link to="/contact" className="inline-block bg-slate-900 text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-slate-800 transition-colors duration-300 shadow-sm">
                            {t('hero.contactButton')}
                        </Link>
                        <Link to="/projects" className="inline-block bg-white text-slate-700 px-8 py-3 rounded-md text-lg font-semibold hover:bg-slate-100 transition-colors duration-300 border border-slate-300 shadow-sm">
