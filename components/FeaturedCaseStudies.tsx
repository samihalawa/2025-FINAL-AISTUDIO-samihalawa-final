...
const headings: Record<LanguageCode, {
  ...
  en: { eyebrow: 'Featured case studies', title: 'Three of five deep dives, with the architecture left in.', body: 'Each case study covers the operating problem, the system architecture and the outcome behind it. Two more, on AutoClient and the APOLO medical framework, are on the full index.', all: 'All five case studies', challenge: 'The problem', build: 'What I built', role: 'Role', open: 'Read the case study', visit: 'Visit the project' },
  es: { eyebrow: 'Casos destacados', title: 'Tres de cinco análisis en profundidad, con la arquitectura incluida.', body: 'Cada caso cubre el problema operativo, la arquitectura del sistema y el resultado obtenido. Los otros dos, AutoClient y el marco médico APOLO, están en el índice completo.', all: 'Los cinco casos', challenge: 'El problema', build: 'Qué construí', role: 'Rol', open: 'Leer el caso', visit: 'Visitar el proyecto' },
  fr: { eyebrow: 'Études de cas mises en avant', title: 'Trois des cinq analyses approfondies, architecture comprise.', body: 'Chaque étude couvre le problème opérationnel, l’architecture du système et le résultat obtenu. Les deux autres, AutoClient et le cadre médical APOLO, figurent dans l’index complet.', all: 'Les cinq études de cas', challenge: 'Le problème', build: 'Ce que j’ai construit', role: 'Rôle', open: 'Lire l’étude de cas', visit: 'Visiter le projet' },
  zh: { eyebrow: '精选案例研究', title: '五个深度案例中的三个，保留完整架构。', body: '每个案例都涵盖运营问题、系统架构与最终成果。另外两个案例（AutoClient 与 APOLO 医疗框架）见完整索引。', all: '全部五个案例', challenge: '问题', build: '构建内容', role: '角色', open: '阅读案例', visit: '访问项目' },
};
