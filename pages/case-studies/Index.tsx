...
const headings: Record<LanguageCode, { eyebrow: string; title: string; body: string; challenge: string; build: string; open: string; technical: string; technicalBody: string; read: string }> = {
  en: { eyebrow: 'Case studies', title: 'Three engineering systems, examined in depth.', body: 'Follow the product decisions, system architecture and operating constraints behind three role-relevant engineering stories.', challenge: 'Operating problem', build: 'System delivered', open: 'Open case study', technical: 'AI engineering deep dives', technicalBody: 'Three evidence-led accounts of the production boundaries, failures and verification behind working AI systems.', read: 'Read technical case study' },
  es: { eyebrow: 'Casos de estudio', title: 'Tres sistemas de ingeniería, explicados en profundidad.', body: 'Descubre las decisiones de producto, la arquitectura y las restricciones operativas de tres historias de ingeniería relevantes para el rol.', challenge: 'Problema operativo', build: 'Sistema construido', open: 'Abrir caso', technical: 'Análisis de ingeniería de IA', technicalBody: 'Tres estudios basados en evidencia sobre los límites, fallos y verificaciones de sistemas de IA en producción.', read: 'Leer caso técnico' },
  fr: { eyebrow: 'Études de cas', title: 'Trois systèmes d’ingénierie étudiés en profondeur.', body: 'Découvrez les décisions produit, l’architecture et les contraintes d’exploitation de trois récits d’ingénierie pertinents pour un rôle senior.', challenge: 'Problème opérationnel', build: 'Système construit', open: 'Ouvrir l’étude', technical: 'Analyses d’ingénierie IA', technicalBody: 'Trois études fondées sur des preuves sur les limites, échecs et vérifications de systèmes IA en production.', read: 'Lire l’étude technique' },
  zh: { eyebrow: '案例研究', title: '深入拆解三个工程系统。', body: '了解三个与高级岗位相关的工程案例背后的产品决策、系统架构与运营约束。', challenge: '运营问题', build: '构建系统', open: '打开案例', technical: 'AI 工程深度解析', technicalBody: '三个基于证据的生产案例，展示真实 AI 系统的边界、故障与验证方法。', read: '阅读技术案例' },
};
