...
const headings: Record<LanguageCode, { eyebrow: string; title: string; body: string; challenge: string; build: string; open: string }> = {
  en: { eyebrow: 'Case studies', title: 'Five production, client-delivery, research and open-source systems, examined in depth.', body: 'Follow the product decisions, system architecture, diagrams and operating outcomes behind five representative systems across marketplace, pricing, revenue operations, medical AI and developer tooling.', challenge: 'Operating problem', build: 'System delivered', open: 'Open case study' },
  es: { eyebrow: 'Casos de estudio', title: 'Cinco sistemas de producción, entrega a clientes, investigación y open source, explicados en profundidad.', body: 'Descubre las decisiones de producto, la arquitectura, los diagramas y los resultados operativos de cinco sistemas representativos: marketplace, pricing, operaciones comerciales, IA médica y herramientas para desarrolladores.', challenge: 'Problema operativo', build: 'Sistema construido', open: 'Abrir caso' },
  fr: { eyebrow: 'Études de cas', title: 'Cinq systèmes de production, de livraison client, de recherche et open source étudiés en profondeur.', body: 'Découvrez les décisions produit, l’architecture, les schémas et les résultats d’exploitation de cinq systèmes représentatifs : marketplace, pricing, opérations commerciales, IA médicale et outils pour développeurs.', challenge: 'Problème opérationnel', build: 'Système construit', open: 'Ouvrir l’étude' },
  zh: { eyebrow: '案例研究', title: '深入拆解五个生产、客户交付、研究与开源系统。', body: '了解市场平台、定价、销售运营、医疗 AI 与开发者工具五个代表性系统背后的产品决策、系统架构、图示与运营成果。', challenge: '运营问题', build: '构建系统', open: '打开案例' },
};
