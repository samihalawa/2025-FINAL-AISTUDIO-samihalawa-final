  ...
  <article className="bg-[#f8f6f1] text-slate-800">
    <div className="container">
      <div className="mx-auto max-w-3xl py-14 sm:py-20">
        ...
        <p className="mt-6 leading-8">The migration moved hosting, the MySQL database, listing media and the WeChat proxy to Coolify on Hetzner with Cloudflare at the edge. The managed-cloud footprint shrank to explicit, optional AI calls. No duplicate datastore was created, and the legacy static bridge stayed in place during cutover.</p>
