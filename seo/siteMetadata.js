...
export const ROUTE_METADATA = [
  ...
  route('/cv', 'Sami Halawa CV | Founding AI & GenAI Engineer', 'Complete CV and focused profiles covering agentic AI, RAG, MCP, Python, TypeScript, production engineering, automation and technical leadership.', { schemaType: 'ProfilePage', alternates: CV_ALTERNATES }),
  ...
  route('/case-studies', 'AI Product & Engineering Case Studies | Sami Halawa', 'Detailed case studies of OULANG, AutoPricing, AutoClient and APOLO across marketplaces, pricing intelligence, revenue operations and medical workflows.', { schemaType: 'CollectionPage', image: '/portfolio/autoclient-operations-cover.webp', imageAlt: 'Connected account research, CRM and communication workflow', imageWidth: 1600, imageHeight: 900, imageMime: 'image/webp', keywords: ['AI case studies', 'multilingual marketplace', 'pricing intelligence', 'revenue operations', 'medical AI'] }),
