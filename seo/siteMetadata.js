...
export const ROUTE_METADATA = [
  ...
  route('/case-studies/vuda', 'VUDA & Agent Developer Tools Case Study | Sami Halawa', 'How VUDA gives coding agents visual access to live interfaces through MCP, with the architecture, runtime loop and adoption figures behind it and its companion tools.', { schemaType: 'TechArticle', image: '/portfolio/vuda-element-map.png', imageAlt: 'VUDA interactive-element map over a live interface capture', imageWidth: 1398, imageHeight: 678, keywords: ['visual debugging agent', 'MCP server', 'coding agents', 'open-source developer tools'] }),
];
