...
export const ROUTE_METADATA = [
  ...
  route('/case-studies', 'AI Architecture Case Studies | Sami Halawa', 'Three anchor case studies with architecture breakdowns and system diagrams: the OULANG marketplace, AutoPricing / IWAKY ERP workflows and VUDA agent developer tools.', { schemaType: 'CollectionPage', image: '/portfolio/autopricing-dashboard.png', imageAlt: 'AutoPricing executive pricing and sourcing dashboard', imageWidth: 2756, imageHeight: 1994, keywords: ['AI case studies', 'multilingual platform', 'pricing intelligence', 'ERP integration', 'agent tooling'] }),
