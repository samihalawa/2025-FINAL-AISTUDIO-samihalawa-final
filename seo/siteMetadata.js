...
export const ROUTE_METADATA = [
  ...
  route('/case-studies/vuda', 'VUDA & Agent Developer Tools Case Study | Sami Halawa', 'How VUDA gives coding agents visual access to live interfaces through MCP, with the architecture, runtime loop and adoption figures behind it and its companion tools.', { schemaType: 'TechArticle', image: '/portfolio/vuda-annotated.png', imageAlt: 'VUDA annotated capture of a live interface', imageWidth: 1398, imageHeight: 2206, keywords: ['visual debugging agent', 'MCP server', 'coding agents', 'open-source developer tools'] }),
];
