...
export const ROUTE_METADATA = [
  ...
  route('/projects', 'AI Products & Engineering Projects | Sami Halawa', 'Production AI systems by Staff AI Architect Sami Halawa: a multilingual marketplace platform, pricing and ERP integration, and open-source agent tooling.', { schemaType: 'CollectionPage', image: '/portfolio/oulang-case-study-cover.webp', imageAlt: 'Selected AI and platform engineering work', imageWidth: 1600, imageHeight: 901, imageMime: 'image/webp', keywords: ['AI products', 'agent systems', 'product engineering', 'multilingual platforms'] }),
  ...
  route('/case-studies', 'AI Architecture Case Studies | Sami Halawa', 'Three anchor case studies with architecture breakdowns and system diagrams: the OULANG marketplace, AutoPricing / IWAKY ERP workflows and VUDA agent developer tools.', { schemaType: 'CollectionPage', image: '/portfolio/oulang-case-study-cover.webp', imageAlt: 'Selected AI and platform engineering case studies', imageWidth: 1600, imageHeight: 901, imageMime: 'image/webp', keywords: ['AI case studies', 'multilingual platform', 'pricing intelligence', 'ERP integration', 'agent tooling'] }),
  ...
  route('/case-studies/vuda', 'VUDA & Agent Developer Tools Case Study | Sami Halawa', 'How VUDA gives coding agents visual access to live interfaces through MCP, with the architecture, runtime loop and adoption figures behind it and its companion tools.', { schemaType: 'TechArticle', image: '/portfolio/vuda-element-map.png', imageAlt: 'VUDA interactive-element map over a live interface capture', imageWidth: 1398, imageHeight: 1603, keywords: ['visual debugging agent', 'MCP server', 'coding agents', 'open-source developer tools'] }),
];
